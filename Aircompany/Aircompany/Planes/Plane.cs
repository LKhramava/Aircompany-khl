...
namespace Aircompany.Planes
{
	public abstract class Plane
	{
		...
		{
			return (obj is Plane plane && Model.Equals(plane.Model) && MaxSpeed.Equals(plane.MaxSpeed)
				&& MaxFlightDistance.Equals(plane.MaxFlightDistance) && MaxLoadCapacity.Equals(plane.MaxLoadCapacity));
		}
